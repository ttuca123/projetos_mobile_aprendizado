...
import br.com.android.util.PermissionsUtil;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //-3.735998, -38.528056
        LatLng location = new LatLng(-3.735998,  -38.528056);
        CameraUpdate position = CameraUpdateFactory.newLatLngZoom(location, 15);

        mMap.animateCamera(position);

        mMap.addMarker(new MarkerOptions().position(location).title("Casa").snippet("minha própria casa"));
